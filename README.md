...
Diskmap is a terminal-based disk usage visualizer inspired by the KDE application [Filelight](https://github.com/KDE/filelight). It offers a cross-platform solution to visualize storage patterns, helping you manage your disk space more effectively.
...
If you're feeling adventurous, you can try building it once the core logic is in place:
```bash
